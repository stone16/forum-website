...
insert into post(author,content,valid,isTop) values(1,'<p>content1</p>',true,true);
insert into post(author,content,valid,isTop) values(1,'<p>content2</p>',true,false);
insert into post(author,content,valid,isTop) values(1,'<p>content3</p>',true,false);